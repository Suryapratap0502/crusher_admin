            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Crushers List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Crusher Management</a></li>
                                <li class="breadcrumb-item active">Crushers List</li>
                            </ol>
                        </div>
                    ...
                    <div class="card" id="customerList">
                        <div class="card-header border-bottom-dashed">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-sm">
                                    <div>
                                        <h5 class="card-title mb-0">Crushers List</h5>
                                    </div>
                                </div>
                                <div class="col-sm-auto">
                                    <div class="d-flex flex-wrap align-items-start gap-2">
                                        <a href="{{ url('crusher_zones/add_from') }}"><button type="button" class="btn btn-primary add-btn"><i class="ri-add-line align-bottom me-1"></i> Add Crusher</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th data-ordering="false">Crusher ID</th>
                                            <th data-ordering="false">Type</th>
                                            <th data-ordering="false">Crusher Name</th>
